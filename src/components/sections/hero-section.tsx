      ...
      <Container className="relative">
        ...
        >
          ...
          <p className="mt-5 max-w-2xl text-pretty text-base leading-relaxed text-muted-foreground sm:text-lg">
            Une demande rapide, un contact humain, une solution locale. PrèsDeToi facilite la mise en relation entre particuliers et prestataires de confiance en Suisse romande.
          </p>
