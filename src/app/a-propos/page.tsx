...
export const metadata: Metadata = buildMetadata({
  title: "A propos | NearYou",
  description: "Mission et vision NearYou pour des services locaux fiables en Suisse romande.",
  path: "/a-propos",
});
    ...
    <section className="py-12 sm:py-16">
      <Container className="max-w-4xl">
        <SectionHeader
          ...
          description="NearYou est ne d'un besoin simple: trouver rapidement un prestataire local fiable, sans friction inutile."
        />
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card className="rounded-2xl border-border/70">
            <CardContent className="space-y-3 pt-6 text-sm leading-relaxed text-muted-foreground">
              ...
              <p>NearYou privilegie la confiance, la transparence et l'efficacite operationnelle.</p>
            </CardContent>
          </Card>
        </div>
      </Container>
