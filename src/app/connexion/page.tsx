...
export const metadata: Metadata = pageMetadata({
  title: "Connexion sécurisée | PrèsDeToi",
  description: "Accédez à votre espace PrèsDeToi.",
  path: "/connexion",
});
    ...
    <section className="py-12">
      <Container className="grid max-w-5xl gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-2xl border border-blue-100 bg-blue-50 p-6">
          <p className="text-sm font-semibold uppercase tracking-wide text-blue-700">Compte PrèsDeToi</p>
          <h1 className="mt-2 text-3xl font-bold text-slate-900">Connexion sécurisée</h1>
          <p className="mt-3 text-sm text-slate-700">Accédez à votre espace PrèsDeToi.</p>
