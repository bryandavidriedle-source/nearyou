  ...
  return (
    <section className="py-12">
      <Container className="max-w-3xl space-y-4">
        <h1 className="text-3xl font-bold text-slate-900">Conditions PrèsDeToi</h1>
        ...
        <div className="grid gap-3">
          ...
          <Card className="premium-card p-4">
            ...
            <p className="mt-1 text-sm text-slate-600">Validation manuelle, âge minimum 15 ans, responsabilités et paiements.</p>
